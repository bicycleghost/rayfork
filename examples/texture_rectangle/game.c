...
void on_init(void)
{
    ...
    scarfy = rf_load_texture_from_file("../../../examples/assets/scarfy.png", RF_DEFAULT_ALLOCATOR, RF_DEFAULT_IO);
...
void on_frame(const input_data input)
{
    ...
    if (input.right_pressed) frames_speed++;
    else if (input.left_pressed) frames_speed--;
